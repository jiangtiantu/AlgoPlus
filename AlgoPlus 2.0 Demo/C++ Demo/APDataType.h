...
/////////////////////////////////////////////////////////////////////////
typedef unsigned int TAPOrderEventIDType;
/// 部分成交，只更新成交量数据
const TAPOrderEventIDType ENUM_OrderEventID_PartTraded = '0';
/// 更新成交量数据，且更新成本数据
const TAPOrderEventIDType ENUM_OrderEventID_TradedAndUpdateCost = '1';
/// 全部成交，只更新成交量数据
const TAPOrderEventIDType ENUM_OrderEventID_AllTraded = '2';
/// 剩余撤单，且更新成交量数据
const TAPOrderEventIDType ENUM_OrderEventID_TradedAndCanceled = '3';
/// 剩余撤单
const TAPOrderEventIDType ENUM_OrderEventID_Canceled = '4';
/// 报单失败
const TAPOrderEventIDType ENUM_OrderEventID_Error = '5';
/// 更新成本数据
const TAPOrderEventIDType ENUM_OrderEventID_UpdateCost = '6';
/// 排队
const TAPOrderEventIDType ENUM_OrderEventID_Waiting = '7';
/// 预埋
const TAPOrderEventIDType ENUM_OrderEventID_Cached = '8';
/// 撤单失败
const TAPOrderEventIDType ENUM_OrderEventID_FailToCancel = '9';

/////////////////////////////////////////////////////////////////////////
/// TAPEventIDType是一个事件ID类型
/////////////////////////////////////////////////////////////////////////
typedef unsigned int TAPEventIDType;
/// 建立TraderApi连接失败
const TAPEventIDType ENUM_EventID_FailToCreateTrader = '0';
/// 初始化失败
const TAPEventIDType ENUM_EventID_FailToInitialize = '1';
/// TraderApi连接断开
const TAPEventIDType ENUM_EventID_TraderDisconnected = '2';
/// 建立MdApi连接失败
const TAPEventIDType ENUM_EventID_FailToCreateMd = '3';
/// MdApi连接断开
const TAPEventIDType ENUM_EventID_MdDisconnected = '4';
/// 订阅行情失败
const TAPEventIDType ENUM_EventID_FailToSubscribeMarketData = '5';
/// 退订行情失败
const TAPEventIDType ENUM_EventID_FailToUnsubscribeMarketData = '6';
/// 切换交易日
const TAPEventIDType ENUM_EventID_DayRolling = 'a';
/// 初始化完成
const TAPEventIDType ENUM_EventID_Ready = 'b';
/// 查询订单
const TAPEventIDType ENUM_EventID_QryOrder = 'c';
/// 查询成交
const TAPEventIDType ENUM_EventID_QryTrade = 'd';
/// 查询持仓
const TAPEventIDType ENUM_EventID_QryPosition = 'e';
/// 查询资金
const TAPEventIDType ENUM_EventID_QryBalance = 'f';
