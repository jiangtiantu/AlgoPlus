...
{
	char szText[4096] = { 0 };
	sprintf(szText, "%s,%s,%s,%d,%d,%d,%d,%d,%d,%s,%s,%d,%s,%c,%d,%c,%c,%c,%c,%d,%f,%lld,%s,%s,%s,%c,%d,%d,%d,%f,%d,%d,%f,%f,%f,%s,%c,%s,%d,%s.",
		...
		pAPOrderField->OrderType,
		int(pAPOrderField->IsLimitOrder),
		pAPOrderField->PriceType,
		pAPOrderField->TimeCondition,
		pAPOrderField->VolumeCondition,
		pAPOrderField->ContingentCondition,
